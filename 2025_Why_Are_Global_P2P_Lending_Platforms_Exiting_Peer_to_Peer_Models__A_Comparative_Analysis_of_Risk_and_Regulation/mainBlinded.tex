...
\textcolor{NavyBlue}{Taken together, these perspectives suggest that governance adaptation in P2P lending is not a uniform process but a choice between fundamentally different strategic pathways. A foundational conceptual framework for understanding this choice is provided by \citet{Hirschman1972}, who distinguishes between two primary responses to deteriorating organizational environments: \textit{exit}---the decision to leave the field---and \textit{voice}---the attempt to adapt from within. Applied to P2P lending, this distinction maps directly onto the two empirically observed outcomes: some platforms have exited the P2P model entirely, while others have restructured their governance while retaining core intermediation functions. Which pathway is taken depends not on the intensity of environmental pressure alone, but on whether viable adaptive alternatives exist \citep{Hirschman1972}. This logic is reinforced by legitimacy theory \citep{Suchman1995}: organizations require regulatory legitimacy to sustain operations; when existing organizational forms can no longer secure that legitimacy but new institutional templates are available, adaptation within a new form is preferred over exit; when no viable template exists, exit becomes the rational response. The conditions that determine which of these two pathways materializes are specified in the propositions that follow.}

\subsection{Theoretical propositions}\label{sec:propositions}

\textcolor{NavyBlue}{Building on the theoretical traditions reviewed above---and anchored in Hirschman's (\citeyear{Hirschman1972}) exit/voice distinction---this study advances two propositions that specify the institutional conditions under which P2P platforms follow each pathway. The central argument is that the character of the regulatory environment, rather than the mere intensity of regulatory pressure, determines whether platforms exit the P2P model entirely or transform their governance structures while retaining core peer-to-peer functions. This distinction draws on the concept of \textit{regulatory field compatibility}: whether the prevailing regulatory framework forecloses or preserves a viable institutional space for P2P activity \citep{DiMaggio1983, Zetzsche2018}.}

\textcolor{NavyBlue}{When a regulatory framework imposes standards---such as bank-equivalent prudential requirements or outright prohibition---that are structurally incompatible with retail-funded P2P intermediation, the institutional space for P2P activity is effectively eliminated. Coercive isomorphism \citep{DiMaggio1983} in this case leaves platforms no conformable template within the field; regulatory legitimacy \citep{Suchman1995} becomes unachievable in the existing organizational form; and exit emerges as the rational response \citep{Hirschman1972}. This configuration corresponds to what \citet{Zetzsche2018} term \textit{regulatory substitution}: the regulatory authority replaces the P2P framework with banking-equivalent standards, displacing rather than accommodating the original model. On this basis, we advance the following proposition:}

\begin{proposition}[Regulatory Field Foreclosure and Platform Exit]
\label{prop1}
\textcolor{NavyBlue}{\textit{P2P lending platforms operating in regulatory environments that structurally eliminate the institutional space for retail-funded peer-to-peer intermediation---through bank-equivalent prudential requirements, explicit prohibition of the model, or rules rendering retail investor participation economically non-viable---will fully exit the P2P model and transition to banking structures or institutional-only funding frameworks.}}
\end{proposition}

\textcolor{NavyBlue}{Conversely, when a regulatory framework creates a new, recognized institutional category for enhanced-compliance P2P activity---such as a specialized non-bank financial intermediary licence or an investment firm classification under securities regulation---platforms retain the possibility of achieving regulatory legitimacy through structural adaptation rather than exit. This corresponds to \textit{regulatory accommodation} \citep{Zetzsche2018}: the regulatory authority carves out a compliance pathway that preserves the core peer-to-peer matching function while imposing investor protection standards. Under these conditions, platforms undergo mimetic isomorphism toward the new institutional template \citep{DiMaggio1983}, transforming their governance and compliance infrastructure while retaining the fundamental architecture of peer-to-peer lending. Hirschman's (\citeyear{Hirschman1972}) voice response is thus enabled precisely by the existence of a viable alternative form toward which adaptation is possible. This leads to the following proposition:}

\begin{proposition}[Regulatory Accommodation and Governance Transformation]
\label{prop2}
\textcolor{NavyBlue}{\textit{P2P lending platforms operating in regulatory environments that create a recognized institutional category for enhanced-compliance peer-to-peer activity---including specialized non-bank financial intermediary licences, investment firm classifications, or equivalent frameworks---will transform their governance and compliance structures while retaining the core peer-to-peer matching function.}}
\end{proposition}

\textcolor{NavyBlue}{Together, these two propositions generate a conditional and differentiated account of platform adaptation: the same coercive pressure that drives one platform to exit may drive another to transform, depending on whether the regulatory environment forecloses or accommodates continued P2P activity. This framing directly addresses the comparative question motivating this study. The propositions guide the cross-case analysis in Sections~\ref{sec: internal_factors} and~\ref{sec:external_factors}, and are revisited in Section~\ref{sec:discussion} to assess how far the empirical patterns align with these theoretical expectations.}
...
\textcolor{NavyBlue}{Primary evidence for this regulatory-driven exit is provided by LendingClub’s direct communication to its retail investor base in October 2020. In a notification email distributed to retail investors concurrently with the company’s SEC Form 8-K filing on 8 October 2020, the company stated: ``Unfortunately, under a prospective banking framework, it is not economically practical for LendingClub to continue to offer Notes. So, we had to make the difficult decision to retire the Notes platform effective December 31, 2020’’ \citep{renton_lendingclub_2020}. This statement, widely reproduced in contemporaneous financial press coverage, unambiguously attributes the closure of the retail P2P investment product to the incompatibility between the banking regulatory framework and the retail notes structure. New retail investment accounts ceased to be accepted from 8 October 2020, and the Notes platform was formally retired on 31 December 2020. The company subsequently redirected its capital market activities toward institutional whole-loan sales, consistent with the operational architecture of a regulated bank.}
...
\textcolor{NavyBlue}{A significant indication of Prosper’s evolving funding strategy is provided by its February 2017 announcement of a wholesale institutional funding commitment. The platform closed a loan purchase agreement with a consortium comprising New Residential Investment Corp., Jefferies Group LLC, Third Point LLC, and an entity managed by Soros Fund Management LLC, covering up to \$5 billion in loans over a 24-month period, supported by warehouse financing from Goldman Sachs, Deutsche Bank, Credit Suisse, and Morgan Stanley \citep{marketplace_prosper_2017}. In its official press release, Prosper described the arrangement as providing ``the funding stability and additional capital markets expertise’’ needed to ``continue to grow our marketplace and achieve profitability.’’ This deal documents a decisive shift in Prosper’s funding structure away from retail peer-to-peer investors toward large institutional counterparties, predating similar transitions at LendingClub and Funding Circle by several years. While Prosper has not formally exited the P2P model, this funding pivot suggests that institutional capital had already begun to displace retail investor funding as the primary driver of loan origination volume by the mid-2010s.}
...
\textcolor{NavyBlue}{CEO Jaidev Janardana provided direct testimony of this regulatory pressure in a 2021 interview, stating: ``Regulation had become overbearing for peer-to-peer lending. We did not feel that business could scale and achieve compelling economics in the long term'' \citep{janardana_zopa_2021}. He further acknowledged the emotional dimension of the decision---``Zopa was the world's first peer-to-peer lending company. We were very emotionally attached''---while affirming that deteriorating consumer sentiment and structural regulatory constraints had rendered the original model non-viable. The CEO's explicit attribution of the exit to the inability of the P2P model to achieve sustainable scale under the prevailing regulatory environment provides unusually clear primary evidence linking FCA policy tightening directly to a platform's strategic withdrawal.}
...
\textcolor{NavyBlue}{In March 2022, Funding Circle announced the permanent closure of its retail investor platform, providing quantitative primary evidence of the extent to which the retail P2P model had already eroded. According to the company’s official investor communication, retail investment volumes had declined by 80\% since the platform suspended new retail inflows in March 2020 to concentrate on government-backed COVID-19 lending schemes, and retail capital represented less than 5\% of total loans under management at the time of the closure \citep{fundin_circle_retail_2022}. In the announcement, CEO Lisa Jacobs stated directly: ``We couldn’t work out how we could operate a sustainable retail product.’’ The platform transitioned fully to an institutional commercial lending model, with funding sourced entirely from institutional investors, government-backed facilities, and capital markets. These figures quantify the degree to which FCA regulatory requirements and pandemic-era disruptions had already structurally displaced retail investors from Funding Circle’s funding base before the formal exit decision was taken.}
...
\textcolor{NavyBlue}{Primary evidence for the scale and duration of this regulatory transition is provided by CEO Martins Sulte’s official statement issued upon receiving the investment firm licence in August 2021: ``Adjusting the business setup and aligning all of the regulatory and licensing requirements has been a unique journey for us and the regulator. It took us almost two years to get here, and I am very pleased to see this come to fruition’’ \citep{blog_mintos_2021}. This statement directly documents the two-year compliance process required to transition from an unregulated marketplace to a MiFID II-licensed investment firm. Sulte further noted that the process involved close coordination with the Latvian regulator to ``ensure that we and those that will follow implement best practices when it comes to the regulated setup and investor protection.’’ The combination of the extended timeline, the depth of structural adjustment required, and the CEO’s explicit acknowledgement of the process’s complexity provides direct primary evidence that the EU’s harmonized regulatory framework functioned as a substantial institutional pressure compelling Mintos to formalize its governance structure in a manner consistent with coercive isomorphism.}
...
\subsection{Regulatory mechanisms: cross-jurisdictional patterns}\label{sec:reg_mechanisms}

\textcolor{NavyBlue}{The preceding subsections document the regulatory environments facing each platform on a jurisdiction-by-jurisdiction basis. While this structure preserves platform-specific detail, it risks obscuring the cross-cutting patterns that emerge when regulatory interventions are examined by mechanism type rather than by geography. This subsection therefore reorganizes the regulatory evidence around three analytical categories—investor protection mechanisms, prudential and licensing requirements, and disclosure and reporting mandates—to reveal how each mechanism type has shaped platform behaviour across different jurisdictions.}

\textcolor{NavyBlue}{\textbf{Investor protection mechanisms.} The most direct regulatory force acting on retail-funded P2P models has been the imposition of investor protection rules that restrict or complicate retail participation. In the United Kingdom, the FCA's PS19/14 policy statement (2019) introduced appropriateness tests for new retail investors and capped the proportion of investable assets that retail clients could allocate to P2P products. These measures sharply reduced new retail investor inflows to platforms such as Zopa, directly undermining the commercial viability of its retail-funded model \citep{fca_ps1914_2018}. In the United States, the SEC's requirement that P2P loan offerings be registered as securities imposed continuous disclosure and compliance obligations on LendingClub and Prosper, raising the cost of maintaining retail-facing investment products \citep{us_securities_and_exchange_commission_secgov_nodate}. In China, the CBIRC's 2019 reforms imposed outstanding loan balance caps that constrained the scale at which retail investors could participate, contributing to the effective shutdown of the sector. Across these three jurisdictions, investor protection mechanisms functioned as a demand-side constraint on P2P models: by limiting the pool of eligible retail investors or raising the cost of their participation, they eroded the foundational premise of peer-based lending.}

\textcolor{NavyBlue}{\textbf{Prudential and licensing requirements.} A second category of regulatory mechanism operates on the supply side of platform capital by imposing institutional-grade standards that effectively push platforms toward banking or investment firm structures. In the UK, Zopa's decision to apply for and obtain a full banking licence from the FCA and PRA in 2020 brought the company under Basel-aligned capital adequacy requirements and AML obligations—standards incompatible with the thinner capital buffers characteristic of P2P intermediaries \citep{zopa_bank_limited_about_nodate}. In the United States, LendingClub's acquisition of Radius Bank in 2021 placed it under OCC and Federal Reserve supervision, which similarly required compliance with bank-level prudential standards. In the EU, Mintos's classification as an investment firm under MiFID II subjected it to capital requirements and conduct-of-business rules more commonly associated with traditional financial intermediaries. In India, the RBI's NBFC-P2P framework formalized a distinct prudential category for P2P platforms, imposing exposure limits and escrow requirements while permitting continued operations within defined boundaries \citep{rbi_non-banking_2017}. Together, these requirements reveal a convergent regulatory dynamic across jurisdictions: as platforms grew, regulators applied increasingly bank-like prudential standards that raised the institutional cost of operating a decentralized, retail-funded model.}

\textcolor{NavyBlue}{\textbf{Disclosure and reporting mandates.} A third mechanism operates through transparency requirements that increase the operational complexity and cost of platform management. MiFID II, applicable to Mintos and Bondora through their EU-based registration, requires ongoing fund segregation, client asset reporting, and conduct disclosures that demand substantial compliance infrastructure \citep{european_securities_and_markets_authority_mifid_2014}. In the US, SEC registration required LendingClub and Prosper to file regular prospectuses and performance updates, creating administrative burdens that scaled with loan volume. Yiren Digital's dual exposure to CBIRC disclosure obligations and SEC-mandated reporting as an NYSE-listed entity further illustrates how overlapping disclosure regimes across jurisdictions can compound compliance costs for internationally active platforms. While disclosure mandates rarely compel platforms to exit the P2P model outright, they systematically shift the cost-benefit calculus of maintaining retail-facing operations, favouring platforms with larger scale, more standardized products, and more centralized governance over those relying on decentralized peer matching.}

\textcolor{NavyBlue}{Taken across these three mechanism types, a consistent pattern emerges: regulatory interventions in the P2P sector have not operated uniformly, but their cumulative effect—regardless of jurisdiction—has been to raise the institutional requirements of P2P lending faster than the original platform model can accommodate. Investor protection rules restricted retail demand; prudential requirements raised institutional supply-side standards; and disclosure mandates increased operational complexity. The variation in platform outcomes observed across the sample is in part a function of which mechanism type was dominant in each jurisdiction, and how the timing and intensity of that mechanism interacted with each platform's internal strategic configuration.}
...
\textcolor{NavyBlue}{
A further pattern that emerges from cross-platform comparison is the striking temporal clustering of strategic transitions between 2019 and 2021. Within this narrow window, Yiren Digital curtailed its P2P operations following Chinese regulatory reforms in 2019; LendingClub discontinued its retail note programme in 2020 following its acquisition of Radius Bank; and Zopa formally closed its P2P lending book in January 2021 after obtaining a banking licence. Funding Circle's pivot toward institutional and government-backed funding also accelerated significantly during 2020. This clustering is unlikely to be coincidental. It reflects the convergence of at least three mutually reinforcing forces. First, a global regulatory tightening cycle reached implementation in this period: the FCA's PS19/14 rules on retail investor protection came into force in December 2019, China's CBIRC enforcement drive effectively wound down the country's entire P2P sector by late 2020, and EU-wide MiFID II obligations continued to raise compliance thresholds for European platforms. Second, the COVID-19 pandemic in 2020 introduced severe credit market disruptions that disproportionately affected retail investor confidence: liquidity withdrawal requests spiked across platforms while borrower default rates rose, exposing the structural fragility of models reliant on dispersed retail funding. Third, and perhaps most importantly, the same period saw institutional capital become increasingly available to scaled P2P platforms as an alternative to retail funding, lowering the switching cost of model transformation. The intersection of these three forces—regulatory pressure, macroeconomic shock, and institutional capital availability—created a structural environment in which the continuation of the original P2P model became simultaneously more costly and less necessary, precipitating the observed cluster of exits and restructurings.
}

\textcolor{NavyBlue}{
Beyond the timing of transitions, institutional investor pressure merits recognition as a distinct and underappreciated explanatory mechanism in its own right. As P2P platforms scaled, retail funding capacity increasingly became a binding constraint: the fragmented, high-maintenance nature of retail investor pools limited the speed and volume at which platforms could grow their loan books. Institutional investors—including asset managers, hedge funds, insurance companies, and government-backed lending schemes—offered a structural alternative, but their participation carried substantive governance conditions. Institutional due diligence processes typically require platforms to provide standardized loan-tape data, independently validated credit models, audit-ready compliance documentation, and regular performance reporting against defined benchmarks. Meeting these requirements compelled platforms to invest in centralized underwriting infrastructure, standardized risk classification, and formal disclosure frameworks that were incompatible with the decentralized, investor-directed model characteristic of original P2P lending. The case of LendingClub is instructive: by 2019, institutional investors already accounted for the substantial majority of the platform's loan funding \citep{dan_ennis_lendingclub_2020}, and the operational complexity of simultaneously maintaining both a retail note programme and an institutional whole-loan channel ultimately rendered the dual structure untenable. Funding Circle's reliance on the UK government's Coronavirus Business Interruption Loan Scheme (CBILS) during 2020 provides a parallel illustration: accessing government-backed institutional capital required the platform to satisfy public procurement and reporting standards that further formalized its operational model \citep{hm_treasury_improving_2024}. The cross-platform evidence presented in this section supports that proposition and suggests that the shift toward institutional capital is not merely a funding substitution but a governance transformation with structural consequences for platform identity and model sustainability.
}

\textcolor{NavyBlue}{
Taken together, these cases illustrate that platforms facing similar external pressures may still arrive at different strategic decisions. Such differences are shaped not only by regulatory design but also by internal factors such as growth ambitions, borrower segments, product scope, and funding scale. Crucially, the 2019--2021 clustering of transformations and the cross-cutting role of institutional investor pressure reveal that platform-level outcomes are not simply a function of jurisdiction-specific regulation, but also of timing, macroeconomic context, and the structural incentives created by the availability of alternative funding models. A full account of P2P platform transformation must therefore consider both the interaction between external regulation and internal strategic configuration, and the broader market conditions that shape when and how that interaction translates into structural change.
}
...
\textcolor{NavyBlue}{To move beyond narrative description and provide a structured basis for the causal analysis, the following table presents a comparative overview of all eight platforms across four key dimensions: original business model, key regulatory milestone(s) and their timing, year of strategic transition, and investor composition shift. Aligning these dimensions enables a direct assessment of whether regulatory events preceded or followed internal strategic change in each case.}

\begin{center}
{\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{tabular}{p{1.7cm} p{1.0cm} p{2.5cm} p{3.5cm} p{1.5cm} p{2.5cm}}

\multicolumn{6}{l}{\textbf{Table 1.} Comparative overview of P2P platform transformations.} \\

\toprule
\textbf{Platform} & \textbf{Market} & \textbf{Original Business Model} & \textbf{Key Regulatory Milestone (Year)} & \textbf{Transition Year} & \textbf{Investor Composition Shift} \\
\midrule
LendingClub & US & Retail P2P marketplace; individual note purchases & Acquisition of Radius Bank; OCC \& Fed banking supervision (2021) & 2020 & Retail notes discontinued; 100\% institutional whole-loan sales \\
\addlinespace
Prosper & US & Retail P2P marketplace; individual note purchases & SEC registration (2009); CFPB oversight (ongoing) & Not transitioned & Predominantly retail; institutional capital supplemental \\
\addlinespace
Zopa & UK & Retail P2P; retail-funded consumer loans & FCA PS19/14 retail restrictions (2019); FCA/PRA banking licence (2020) & 2021 & Retail P2P investors exited; deposit-funded banking model \\
\addlinespace
Funding Circle & UK & SME P2P marketplace & FCA rules (2019); Brexit passporting loss (2020) & Partial (2020+) & Mixed retail/institutional shifting to institutional-dominant \\
\addlinespace
Yiren Digital & China & Algorithmic P2P; platform-matched consumer loans & CBIRC sweeping reforms; balance caps (2019) & 2019--20 & Retail investors wound down; restructured as digital finance \\
\addlinespace
Mintos & EU (LV) & Secondary loan marketplace; P2P claims on originators & FKTK investment firm licence; MiFID II compliance (2022) & Adapted (no exit) & Retail investors retained under MiFID II restrictions \\
\addlinespace
Bondora & EU (EE) & Retail P2P; consumer loans across Europe & EFSA supervision; MiFID II (ongoing) & Not transitioned & Retail investors maintained \\
\addlinespace
Faircent & India & Retail P2P marketplace; NBFC-P2P & RBI NBFC-P2P regulatory framework (2017) & Formalized (no exit) & Retail lenders maintained within RBI exposure caps \\
\bottomrule
\end{tabular}
}
\end{center}

\textcolor{NavyBlue}{The table reveals meaningful heterogeneity in the causal structure of platform transitions, allowing the co-evolutionary framing advanced earlier in this paper to be operationalized rather than merely asserted. Three distinct temporal patterns emerge from aligning regulatory milestones with transition years. In the first pattern, regulatory intervention was the clear proximate cause: Yiren Digital's restructuring was precipitated directly by the 2019 CBIRC reforms, which mandated outstanding balance caps and effectively foreclosed continued P2P operations, leaving the platform no strategic alternative. Zopa's exit similarly followed the FCA's PS19/14 rules, which introduced retail investor appropriateness tests that sharply reduced new investor inflows and rendered the retail P2P model commercially unviable—here regulation functioned as the triggering event, while internal pressures on investor trust amplified the impact. In the second pattern, internal strategic evolution was the primary driver, with regulatory change serving as an enabling rather than coercive force: LendingClub's decision to pursue a banking charter and discontinue retail notes was motivated primarily by the operational and economic unsustainability of managing a large fragmented retail investor base at scale; the transition to formal banking supervision followed and formalized this strategic orientation rather than compelling it. In the third pattern, regulatory tightening and internal operational strain were genuinely concurrent and mutually reinforcing: Funding Circle encountered Brexit-related passporting losses and COVID-19 loan volume disruptions simultaneously, making it analytically difficult to assign clear temporal priority to either driver—this case most closely exemplifies the co-evolutionary dynamic. Platforms that did not transition—Prosper, Bondora, and Faircent—suggest that neither regulatory pressure nor internal fragility alone is sufficient to trigger model exit; their continued operation indicates that lighter-touch supervision and narrower product scope can allow P2P structures to persist. Taken together, this cross-platform comparison operationalizes the study's central theoretical claim: the relationship between regulatory pressure and platform adaptation is contingent on the form and intensity of the regulatory intervention, the platform's internal strategic configuration, and the sequencing of pressures. No single causal arrow adequately describes the full sample.}
...
\newpage
\bibliography{references}% common bib file + new references for theoretical propositions
